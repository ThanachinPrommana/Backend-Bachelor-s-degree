// Scheduler/notificationScheduler.js (CommonJS)
...
// --- ฟังก์ชันที่ 3: แจ้งเตือน "ถึงเวลาแล้ว" นาทีต่อ นาที ---
...
const startNotificationSchedulers = () => {
  ...
  cron.schedule("0 9 * * *", checkAndSendReminders, { timezone: "Asia/Bangkok" }); // แจ้งเตือนล่วงหน้า (พรุ่งนี้) 09:00
  cron.schedule("0 8 * * *", checkAndSendDayOfAlerts, { timezone: "Asia/Bangkok" }); // แจ้งเช้าวันนัด 08:00
